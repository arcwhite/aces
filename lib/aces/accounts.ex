defmodule Aces.Accounts do
  ...
  alias Aces.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Aces.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Aces.Accounts.User.password_changeset/3` for a list of supported options.
  ...
  This only confirms the email without logging the user in 
  (they must use their password to log in).
  """
