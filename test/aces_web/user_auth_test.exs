defmodule AcesWeb.UserAuthTest do
  use AcesWeb.ConnCase, async: true

  alias Aces.Accounts
  alias Aces.Accounts.Scope
  alias AcesWeb.UserAuth

  import Aces.AccountsFixtures

  @remember_me_cookie "_aces_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, AcesWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
